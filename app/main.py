...
if sys.version_info < MIN_SUPPORTED or sys.version_info > MAX_SUPPORTED:
    raise RuntimeError(
        "This demo currently supports Python 3.10–3.12. "
        "Please use a supported interpreter version to avoid FastAPI/Pydantic import errors."
    )
